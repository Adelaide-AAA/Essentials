...
//Name: Bedroom Scene3.ma
//Last modified: Wed, Nov 19, 2025 10:09:04 PM
//Codeset: 1252
...
fileInfo "UUID" "B4F28618-4575-92F4-206A-EF996BDC4689";
createNode transform -s -n "persp";
	rename -uid "7BAFBE88-4C01-02A0-9044-F4AE6F6838BA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 31.436046678530118 26.965627004996168 27.662019720669765 ;
	setAttr ".r" -type "double3" -22.538352729902364 408.59999999975207 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 46.015178104722963;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.44418716430664062 9.3279275894165039 -0.44418716430664062 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "53B77FF2-472D-4184-ED1D-B488B2D99296";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1035FD43-4B75-9581-EAB8-159EA94948C3";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9B47BB96-4FC0-5338-1587-6798FECA6161";
createNode displayLayerManager -n "layerManager";
	rename -uid "363A0F50-4D39-5378-471B-42BD60679C48";
createNode displayLayer -n "defaultLayer";
	rename -uid "6921796E-4725-8E77-C3C0-E9A76CE13600";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BEDA5ADA-4F9D-FFFF-6F85-9BAF6F16B291";
...
createNode polyTweak -n "polyTweak4";
	...
	setAttr ".uopa" yes;
	setAttr -s 6 ".tk";
	setAttr ".tk[8]" -type "float3" 0 4.4178591 0 ;
	setAttr ".tk[9]" -type "float3" 0 4.4178591 0 ;
	setAttr ".tk[10]" -type "float3" 0 4.4178591 0 ;
	setAttr ".tk[11]" -type "float3" 0 4.4178591 0 ;
