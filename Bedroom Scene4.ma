...
//Name: Bedroom Scene4.ma
//Last modified: Fri, Nov 21, 2025 04:01:29 PM
//Codeset: 1252
...
fileInfo "UUID" "E53E2E72-4C4E-F92B-56B2-B9828CED85C4";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "7BAFBE88-4C01-02A0-9044-F4AE6F6838BA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 31.490767090642365 30.3814924731461 22.450433573350072 ;
	setAttr ".r" -type "double3" -21.338352729556288 415.39999999950589 -2.8005544739480501e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 46.383784934541765;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -4.0720803351345936 13.503601736418473 -2.0827315731900073 ;
...
createNode mesh -n "polySurfaceShape6" -p "polySurface1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.43572328984737396 0.56231516599655151 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode transform -n "Chair";
	...
	setAttr ".t" -type "double3" 0 0.6298753023147583 0 ;
...
createNode mesh -n "pCubeShape53" -p "pCube53";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 24 ".pt";
	setAttr ".pt[0]" -type "float3" 0.79458106 -1.0703694 0 ;
	setAttr ".pt[2]" -type "float3" 0.99423444 -0.7977336 0 ;
	setAttr ".pt[4]" -type "float3" 0.99423444 -0.7977336 0 ;
	setAttr ".pt[6]" -type "float3" 0.79458106 -1.0703694 0 ;
	setAttr ".pt[16]" -type "float3" -0.19819981 -7.1525574e-07 0 ;
	setAttr ".pt[17]" -type "float3" -0.16330801 -0.020538848 0 ;
	setAttr ".pt[18]" -type "float3" -0.16330801 -0.020538848 0 ;
	setAttr ".pt[19]" -type "float3" -0.19819981 -7.1525574e-07 0 ;
	setAttr ".pt[20]" -type "float3" 0.99423444 -0.7977336 0 ;
	setAttr ".pt[21]" -type "float3" 0.79458106 -1.0703694 0 ;
	setAttr ".pt[22]" -type "float3" -0.19819981 -7.1525574e-07 0 ;
	setAttr ".pt[29]" -type "float3" -0.16330801 -0.020538848 0 ;
	setAttr ".pt[42]" -type "float3" -0.010748032 0 0 ;
	setAttr ".pt[43]" -type "float3" -0.035511333 0 0 ;
	setAttr ".pt[44]" -type "float3" -0.035511333 0 0 ;
	setAttr ".pt[45]" -type "float3" -0.035511333 0 0 ;
	setAttr ".pt[46]" -type "float3" -0.010748032 0 0 ;
	setAttr ".pt[47]" -type "float3" -0.010748032 0 0 ;
	setAttr ".pt[48]" -type "float3" 0.47942281 -0.32813951 0 ;
	setAttr ".pt[49]" -type "float3" 0.50959897 -0.08812622 0 ;
	setAttr ".pt[50]" -type "float3" 0.50959897 -0.08812622 0 ;
	setAttr ".pt[51]" -type "float3" 0.50959897 -0.08812622 0 ;
	setAttr ".pt[52]" -type "float3" 0.47942281 -0.32813951 0 ;
	setAttr ".pt[53]" -type "float3" 0.47942281 -0.32813951 0 ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4C37B9C5-49A9-261A-2BE3-FE9842AA2213";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CE6E46B7-413E-6CDA-1D3B-8794E4089151";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3CAAA9C9-415A-EFAB-BCDF-A1BAB3A88795";
createNode displayLayerManager -n "layerManager";
	rename -uid "302255AA-4CBC-9482-01D5-36A7DDFF71DE";
createNode displayLayer -n "defaultLayer";
	rename -uid "6921796E-4725-8E77-C3C0-E9A76CE13600";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "633DA389-4084-01EB-4CB4-8FB53ED7D809";
...
connectAttr "polySplit34.out" "pCubeShape53.i";
